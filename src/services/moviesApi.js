...
export const fetchTrendingMovies = async (searchQuery) => {
    const API_KEY = 'cdce60bca2fa8769cb98ca2cac52f3de';
    const response = await axios.get(`https://api.themoviedb.org/3/trending/movie/week?api_key=${API_KEY}&query=${searchQuery}`);
